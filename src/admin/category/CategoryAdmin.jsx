    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const isDuplicate = categories.some(
                (c) => c.codeId.trim().toLowerCase() === formData.codeId.trim().toLowerCase() && c._id !== editingCategory?._id
            );
            ...
            const url = editingCategory
                ? `http://localhost:5000/category/${editingCategory._id}` // API cập nhật danh mục
                : "http://localhost:5000/category"; // API thêm danh mục mới
            ...
            setFormData({ name: "", codeId: "" }); // Reset form
        } catch (error) {
